...
AUnrealAxeThrowCharacter::AUnrealAxeThrowCharacter()
{
...
void AUnrealAxeThrowCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void AUnrealAxeThrowCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AUnrealAxeThrowCharacter::Move);
...
void AUnrealAxeThrowCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AUnrealAxeThrowCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
